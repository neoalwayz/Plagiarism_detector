...
public class Simhash2<T> {
	 ...
	 public static <T> Simhash2<T> build(List<T> dimensions){
	 ...
	 public static <T> Simhash2<T> build(List<T> dimensions, Hashing<T> hashing){
		 Simhash2<T> ret = new Simhash2<T>();
